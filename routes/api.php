...
Route::post('ads_with_provider_id','API\AdsApiController@ads_with_provider_id');
Route::post('ads_with_Cat_customer','API\AdsApiController@ads_with_Cat_customer');
...
Route::post('cat_superAdmin_cost','API\CategoryApiController@cat_superAdmin_cost');

Route::post('settings','API\settingsApiController@index');
Route::post('update_settings','API\settingsApiController@update');

Route::post('changePass','API\registerApiController@changePass');
