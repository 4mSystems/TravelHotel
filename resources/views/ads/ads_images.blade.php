    ...
    <div class="app-content content container-fluid">
        <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('ads_admin')}}">{{trans('admin.nav_ads_admin')}}</a></li>
                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title icon-image4">{{trans('admin.ads_showImages')}} ({{ count($ads_images) }})</h4>
